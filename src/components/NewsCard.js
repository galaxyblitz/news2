...
import {CONTRACT_OWNER, IPFS_GET_LINK, CHAIN_ID} from "../utils/Constants";
            ...
            <Box p={6}
                ...
                <Box mb={6}
                    ...
                    <Image w={'100%'}
                           ...
                           pb={'15px'}
                           objectFit={'cover'}
                           src={imageSrc ? IPFS_GET_LINK + imageSrc : DefaultNewsLogo}
                    />
                </Box>
                <Stack>
                    <Heading
                        ...
                        <Stack spacing={0}
                            ...
                            <Text fontWeight={600}>
                                <Tooltip label={author}>
                                    <Badge color={'green'} textTransform={'none'}>
                                        {author.substr(0, 13) + "..." + author.substr(author.length - 13)}
                                    </Badge>
                                </Tooltip>
                            </Text>
                            <Text color={'gray.500'}>
